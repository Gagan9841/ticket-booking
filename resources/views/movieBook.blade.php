...
<body onload="onLoaderFunc()">
    ...
    <div class="inputForm">
    <center>
      Name *: <input value="{{auth()->user()->name}}" id="Username" readonly required>
      Ticket Number *: <input  value="#{{random_int(100000,999999)}}" id="ticketNo" readonly  required>
      Movie Name *: <input  value="{{$movies->name}}" id="movie" readonly  required>
    ...
    <br/><button type="button" class="btn btn-warning" onclick="updateTextArea()">Confirm Selection</button>
    </center>
    </div>
    ...
    <center>
      ...
      <tr>
        <td><textarea  id="nameDisplay"></textarea>
            <input type="hidden" name="user_name" value="{{auth()->user()->id}}">
        </td>
        <td><textarea name="ticket_no" id="TicketDisplay"></textarea></td>
        <td><textarea id="movieDisplay"></textarea>
            <input type="hidden" name="movie_name" value="{{$movies->id}}">
        </td>
